  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <section><h2>Outbids and refunds</h2><p>Every claimed position remains open to a minimum bid $5 above the active sponsorship. A challenger may voluntarily raise that amount in $1 steps. If a challenger completes payment, the prior sponsor’s original Stripe payment is automatically refunded and the challenger becomes the visible sponsor. Reversible demo placements have no real payment to refund.</p></section>
